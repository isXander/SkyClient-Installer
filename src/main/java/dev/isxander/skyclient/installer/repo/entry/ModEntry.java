...
public class ModEntry {
    ...
    public ModEntry(String id, boolean enabled, String fileName, String downloadUrl, String displayName, String description, String iconFile, String iconScaling, String creator, String[] packRequirements, String[] modRequirements, EntryAction[] actions, EntryWarning warnings, String[] files, boolean hidden) {
        this.id = id;
